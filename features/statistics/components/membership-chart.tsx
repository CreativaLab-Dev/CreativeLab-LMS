    ...
    <Card>
      <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
        <div className="grid flex-1 gap-1 text-center sm:text-left">
          ...
          <CardDescription>
            Se muestra las membresias por mes
          </CardDescription>
        </div>
      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
        ...
        >
          <BarChart accessibilityLayer data={chartMembershipData}>
            ...
            <Bar dataKey="membershipMonthlyCount" fill="var(--color-membershipMonthlyCount)" radius={2} />
            <Bar dataKey="membershipYearlyCount" fill="var(--color-membershipYearlyCount)" radius={2} />
          </BarChart>
        </ChartContainer>
      </CardContent>
    </Card>
