...
export function PaginationList({ result, path }: PaginationListProps) {
  const router = useRouter();
  const params = useSearchParams();

  const { total, page, sizePage } = result;
  ...
  return (
    <div className="flex flex-col sm:flex-row">
      ...
      <div className="flex-grow text-sm text-gray-500 text-center flex-1 flex items-center justify-center">
